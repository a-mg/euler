;;;; number.ss
;;;; Provides utility functions for working with numbers
...
;;; Calculate the base-10 log of a number.
(define (log10 n)
  (/ (log n) (log 10)))
...
;;; Given a number n and a power of ten t, find the
;;; appropriate digit of n.
;;; (digit 3 432) -> 4
(define (digit t n)
  (string->number (substring (reverse-string (number->string n)) t (+ t 1))))



;;; Given a list of strings, group every three strings
